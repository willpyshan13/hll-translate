package com.hll.chat.conference;
...
import com.hll.chat.utils.PhoneStateManager;
import com.hll.chat.utils.PreferenceManager;
import com.hll.chat.widget.EasePageIndicator;
...
public class ConferenceActivity extends BaseActivity implements EMConferenceListener {
    ...
    private View.OnClickListener listener = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            int i = view.getId();// 全屏状态下切换视频scale mode
// 显示悬浮框
